                    ...
                    <div class="w-full inline-block inline-flex justify-between">
                        <div class="inline-block">
                            ...
                            <button @click.prevent="getData"
                                ...
                                :class="googleSheetId.trim().length == 0 ? 'opacity-50 cursor-not-allowed' : ''"
                                :class="googleSheetId.trim().length > 0 ? 'hover:bg-green-700' : ''"
                            >
                            ...
                            <button @click.prevent="sendEmail"
                                ...
                                :class="givingData.length == 0 ? 'opacity-50 cursor-not-allowed' : ''"
                                :class="givingData.length > 0 ? 'hover:bg-green-500 hover:text-white hover:border-transparent' : ''"
                            >
                                {{ isSendingEmails ? 'Sending...' : 'Send Emails' }}
                            </button>
                        </div>
                        <!-- CSS Preloader -->
                        <div v-show="isGettingData" 
                    ...
                    <template v-if="givingData.length > 0">
                        ...
                        >
                            ...
                            <td class="border-t-2 px-4 py-2">
                                <span class="font-bold">{{ data.fullName }}</span> <br> 
                                <span class="text-gray-600 text-sm">{{ data.firstName }}</span> <br>
                                <span class="text-gray-600 text-sm">{{ data.emailTo }}</span> <br>
                                <span class="text-gray-600 text-sm">{{ data.givingMethod }}</span> <br>
                                <span class="text-gray-600 text-sm">{{ data.timestamp }}</span>
                            </td>
                            <!-- Giving details -->
                            <td class="border-t-2 px-4 py-2">
