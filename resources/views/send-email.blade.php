...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100">
        ...
        <nav class="flex items-center justify-center flex-wrap bg-gradient-to-r from-green-500 to-blue-900 p-6">
        ...
        <header class="bg-white shadow">
            <div class="container mx-auto py-4 flex justify-between">
                ...
                {{-- Logout --}}
                <div class="pt-2">
                    <a class="inline-block align-baseline text-sm text-blue-500 hover:text-blue-700 inline-flex items-center" 
                        href="{{ route('logout') }}"
        ...
        <main id="app">
            <div class="container min-h-screen mx-auto py-12">
            @verbatim
                <!-- Google Sheet ID input -->
                <div class="w-full max-w-lg mb-10">
                    <form class="bg-white shadow rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4">
                            <label class="block text-gray-700 text-md font-semibold mb-2" for="sheet-id">
                                Google Sheet ID
                            </label>
                        ...
                        <div class="w-full inline-block inline-flex justify-between">
                            <div class="inline-block">
                                ...
                                <button @click.prevent="getData"
                                    class="bg-blue-600 text-white mr-2 py-1 px-3 rounded"
                                ...
                                <button @click.prevent="sendEmail"
                                    class="bg-transparent text-blue-800 py-1 px-3 border border-blue-600 rounded"
                ...
                <div class="flex flex-col"
                    v-show="givingData.length > 0" 
                >
                <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="max-w-4xl mx-auto overflow-hidden shadow border-b border-gray-200 sm:rounded-lg">
                <table class="bg-white w-full max-w-4xl divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider">Person Details</th>
                            <th class="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider">Giving Details</th>
                    ...
                    <tbody>
                        <template v-if="givingData.length > 0">
                            ...
                            >
                                ...
                                <td class="border-t-2 px-4 py-2">
                                    <span class="inline-block align-baseline inline-flex items-center font-bold">
                                        <span @click.prevent="viewHtmlTemplate(index)"
                                            class="text-sm hover:text-blue-700 cursor-pointer"
                                        >
                                            {{ data.fullName }}
                                        </span>
                                        ...
                                        >
                                            <svg 
                                                class="fill-current w-4 h-4 ml-2 text-blue-700 tooltip" xmlns="http://www.w3.org/2000/svg" 
                                                viewBox="0 0 20 20"
                                            >
                                                <path d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm12.73-1.41A8 8 0 1 0 4.34 4.34a8 8 0 0 0 11.32 11.32zM6.7 9.29L9 11.6l4.3-4.3 1.4 1.42L9 14.4l-3.7-3.7 1.4-1.42z"/>
                                            </svg>
                                            <span class='tooltip-text bg-blue-200 p-3 -mt-6 ml-8 rounded text-sm'>Acknowledged on {{ data.dateAcknowledged }}</span>
                                        </span>
                                    </span> <br> 
                                    <span class="text-sm">
                                        {{ data.firstName }}
                                ...
                                <!-- Total Amount -->
                                <td class="border-t-2 px-4 py-2 text-right text-sm font-semibold">
                                    PHP {{ data.total }}
                                </td>
                            </tr>
                        </template>
